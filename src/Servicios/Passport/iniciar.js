...
import { RepositorioUser } from "../../Repositorios/index.js";
...
const iniciar = () => {
    ...
    passport.deserializeUser(async (id, done) => {
        const usuario = await RepositorioUser.obtenerXid(id);
        done(null, usuario);
    });
    ...
    passport.use("login", new LocalStrategy({
        ...
        try {
            const usuario = await RepositorioUser.obtenerUno({ 'email': usuario });
            if (!usuario) {
    ...
    passport.use("signup", new LocalStrategy({
        ...
        try {
            ...
            const usuarioYaExiste = await RepositorioUser.obtenerUno({ 'email': usuario });
            ...
            if (usuarioYaExiste) {
                ...
                const usuarioCreado = await RepositorioUser.guardar(nuevoUsuario)
